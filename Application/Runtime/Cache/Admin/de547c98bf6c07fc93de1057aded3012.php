...
<body>
<div class="midder">
    <form action="<?php echo U('/Admin/Case/case_add');?>" method="post" name="form" id="myform" enctype="multipart/form-data">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="tr rt">
                <td width="100">感言：</td>
                <td colspan="3" class="lt">
                    <textarea rows="3" cols="50" name="jianyan"></textarea>
                </td>
            </tr>
            ...
            <tr class="tr rt">
                ...
                <td colspan="3" class="lt">
                    <textarea name='course' id="ue_content" style="width:800px;height:250px;"></textarea>
                </td>
            </tr>
