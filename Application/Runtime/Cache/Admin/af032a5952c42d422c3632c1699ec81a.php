...
<tr>
    ...
    <?php if(!empty($info["img_url"])): ?><img src="<?php echo (substr($info["img_url"],1)); ?>"><?php endif; ?>
                    </td>
                </tr>
				...
				<tr class="tr rt">
                    ...
                    <td colspan="3" class="lt">
						<input type="file" name="th_img_url" size="28" value='浏览...'  />
                            <?php if(!empty($info["th_img_url"])): ?><img src="<?php echo (substr($info["th_img_url"],1)); ?>"><?php endif; ?>
                    </td>
                </tr>
                ...
                <tr class="tr rt">
                    ...
                    <td colspan="3" class="lt">
                        <input type="file" name="bg_img_url" size="28" value='浏览...' />
                            <?php if(!empty($info["bg_img_url"])): ?><img src="<?php echo (substr($info["bg_img_url"],1)); ?>"><?php endif; ?>
                    </td>
                </tr>
				...
				<tr class="tr rt">
                    ...
                    <td colspan="3" class="lt">
						<textarea name='index_message' rows='5' cols='50'><?php echo ($info["index_message"]); ?></textarea>
					</td>
                </tr>
				...
				<tr class="tr rt">
                    ...
                    <td colspan="3" class="lt">
						<textarea name='message' rows='5' cols='50'><?php echo ($info["message"]); ?></textarea>
					</td>
                </tr>
				...
				<tr class="tr rt">
                    ...
                    <td colspan="3" class="lt">
						<textarea name='message_e' rows='5' cols='50'><?php echo ($info["message_e"]); ?></textarea>
					</td>
                </tr>
