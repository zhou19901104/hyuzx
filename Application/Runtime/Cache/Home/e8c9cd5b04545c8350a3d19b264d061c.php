...
<div class="talk">
	<div class="online">
		<ul>
			...
			<li class="li-3"><a href="javascript:void(0)">010-57290100</a></li>
		</ul>
	</div>
	<div class="ewm"></div>
	<ul class="flo-list">
...
<div class="case-wrap">
	...
	<div class="ca-list">
		<div class="calist">
			<ul class="caslide">
				<?php if(is_array($anli_list_a)): $i = 0; $__LIST__ = $anli_list_a;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a_list): $mod = ($i % 2 );++$i;?><li class="li-1">
						<a class="jump">
...
<div class="new-cont-wrap">
	<div class='con-list-wrap prcont'>
		...
		<ul class="text-list">
			<?php if(is_array($related_list)): $i = 0; $__LIST__ = $related_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$related_list): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Index/Index/new_info',array('id'=>$related_list['id'],'cid'=>$related_list['cid']));?>"><?php echo ($related_list["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
		</ul>
	</div>
<!-- 相关专家推荐 -->
	<div class='con-list-wrap'>
		<p class="tit ptit">相关推荐<span>related suggestion</span> <span class="pmore"><a href="<?php echo U('Index/Index/doctor_list');?>">更多&nbsp;></a></span></p>
		<ul class="zj-list">
			<?php if(is_array($doctor_list)): $i = 0; $__LIST__ = $doctor_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$doctor_list): $mod = ($i % 2 );++$i;?><li>
					<a href="<?php echo U('Index/Index/doctor_info',array('id'=>$doctor_list['id']));?>">
						<img src="/Public/Uploads/doctor/list_<?php echo ($doctor_list["img_url"]); ?>" alt="">
						<p class="p-1"><?php echo ($doctor_list["name"]); ?></p>
						<p class="p-2"><?php echo ($doctor_list["zhicheng"]); ?></p>
					</a>
					<p class="p-3"><a target='_blank' href="http://pkt.zoosnet.net/LR/Chatpre.aspx?id=PKT67204838&cid=1469000068684805339274&lng=cn&sid=1469000068684805339274&p=http%3A//hyuzx.com/&rf1=&rf2=&e=%25u6765%25u81EA%25u9996%25u9875%25u7684%25u5BF9%25u8BDD&bid=&d=1469000257113">在线预约</a></p>
				</li><?php endforeach; endif; else: echo "" ;endif; ?>
		</ul>
	</div>
<!-- 相关案例 -->
	<div class='con-list-wrap'>
		...
		<ul class="diary-list">
			<?php if(is_array($anli_list)): $i = 0; $__LIST__ = $anli_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a_list): $mod = ($i % 2 );++$i;?><li class="bd">
					<a href="<?php echo U('Index/Index/case_info',array('id'=>$a_list['id']));?>">
						<img src="/Public/Uploads/anli/list_<?php echo ($a_list["list_url"]); ?>" alt="">
						<ul class="text">
							<!--<li class="p-1"><img src="/Public/index/images/case-min-1.png" alt=""></li>-->
							<li class="p-1"><img src="/Public/Uploads/anli/min_<?php echo ($a_list["min_url"]); ?>" alt=""></li>
							<li class="p-2">
								<p class="name"><?php echo ($a_list["name"]); ?><span>They are here to find the youth and beauty</span></p>
								<p class=" explain"><?php echo ($a_list["jianyan"]); ?></p>
							</li>
						</ul>
					</a>
				</li><?php endforeach; endif; else: echo "" ;endif; ?>
