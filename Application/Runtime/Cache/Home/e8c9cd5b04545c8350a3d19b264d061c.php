...
<div class="new-cont-wrap">
	...
	<div class='con-list-wrap'>
		<p class="tit ptit">相关推荐<span>related suggestion</span> <span class="pmore"><a href="<?php echo U('Home/Index/doctor_list');?>">更多&nbsp;></a></span></p>
		<ul class="zj-list">
			<?php if(is_array($doctor_list)): $i = 0; $__LIST__ = $doctor_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$doctor_list): $mod = ($i % 2 );++$i;?><li>
					<a href="<?php echo U('Home/Index/doctor_info',array('id'=>$doctor_list['id']));?>">
						<img src="<?php echo C('SITE_URL'); echo (substr($doctor_list["img_url"],1)); ?>" alt="">
	...
	<!--<div class='con-list-wrap'>-->
		...
		<!--<ul class="diary-list">-->
			...
			<!--<?php if(is_array($anli_list)): $i = 0; $__LIST__ = $anli_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a_list): $mod = ($i % 2 );++$i;?>-->
				<!--<li class="bd">-->
					<!--<a href="<?php echo U('Home/Index/case_info',array('id'=>$a_list['id']));?>">-->
						<!--<img src="/Public/Uploads/anli/list_<?php echo ($a_list["list_url"]); ?>" alt="">-->
						<!--<ul class="text">-->
							<!--&lt;!&ndash;<li class="p-1"><img src="<?php echo C('IMG_URL');?>/case-min-1.png" alt=""></li>&ndash;&gt;-->
