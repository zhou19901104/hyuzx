  ...
  <div class="doctor">
    <div class="zj-list">
      ...
      <div class="r-b-wrap">
        <div class="r-b">
          <ul class="zjslide">
            <li><a href="<?php echo C('SITE_URL');?>/Home/Index/doctor_info/id/6"><img src="/Public/index/images/z-0.png"
                                                                                 alt=""></a></li>
            <li><a href="<?php echo C('SITE_URL');?>/Home/Index/doctor_info/id/12"><img src="/Public/index/images/z-4.png"
                                                                                  alt=""></a></li>
            <li><a href="<?php echo C('SITE_URL');?>/Home/Index/doctor_info/id/15"><img src="/Public/index/images/z-12.png"
                                                                                  alt=""></a></li>
            <!-- <li><a href="javascript:void(0);"><img src="/Public/index/images/z-1.png" alt=""></a></li> -->
            <li><a href="<?php echo C('SITE_URL');?>/Home/Index/doctor_info/id/14"><img src="/Public/index/images/z-6.png"
                                                                                  alt=""></a></li>
            <li><a href="<?php echo C('SITE_URL');?>/Home/Index/doctor_info/id/11"><img src="/Public/index/images/z-2.png"
                                                                                  alt=""></a></li>
            <!-- <li><a href="javascript:void(0);"><img src="/Public/index/images/z-3.png" alt=""></a></li> -->

            <li><a href="<?php echo C('SITE_URL');?>/Home/Index/doctor_info/id/13"><img src="/Public/index/images/z-5.png"
                                                                                  alt=""></a></li>
          </ul>
        </div>
        <span class="s-s-l"></span>
...
<div class="huan-wrap">
  <div class="huanjing">
    <p class="huan-tit"><img src="/Public/index/images/hj-tit.png" alt=""></p>
    <div class="j-1">
  ...
  <div class="huan-list">
    <div class="gallery">
      <ul class="hjslide ">
        <li><a href="/Public/index/images/hj-1-b.png"><img src="/Public/index/images/hj-1.png" alt=""></a></li>
        <li><a href="/Public/index/images/hj-2-b.png"><img src="/Public/index/images/hj-2.png" alt=""></a></li>
        <li><a href="/Public/index/images/hj-3-b.png"><img src="/Public/index/images/hj-3.png" alt=""></a></li>
        <li><a href="/Public/index/images/hj-4-b.png"><img src="/Public/index/images/hj-4.png" alt=""></a></li>
        <li><a href="/Public/index/images/hj-5-b.png"><img src="/Public/index/images/hj-5.png" alt=""></a></li>
      </ul>
      <div class="clear"></div>
    </div>
    <span class="s-s-l"></span>
...
<div class='video-wrap'>
  <p class="vi-tit"><img src="/Public/index/images/video-tit.png" alt=""></p>
  <div class="video-list">
    <div class="wrap">
      ...
      <div class="w_r">
        <span class="s-prev"><img src="/Public/index/images/prev_page.png"></span>
        <div class="w_r_w">
          <ul class="show_off">

            <!--<li><img rel='/Public/video/video_1.mp4' src="/Public/index/images/v-1-1.jpg" alt=""></li>-->
            <li><img rel='/Public/video/video_2.mp4' src="/Public/index/images/v-1-3.jpg" alt=""></li>
            <li><img rel='/Public/video/video_3.mp4' src="/Public/index/images/v-1-2.jpg" alt=""></li>
            <li><img rel='/Public/video/video_4.mp4' src="/Public/index/images/v-1-4.jpg" alt=""></li>
