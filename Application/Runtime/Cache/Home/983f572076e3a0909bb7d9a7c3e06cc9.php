...
<div class="case-wrap">
  ...
  <div class="ca-list">
    ...
    <div class="calist">
      ...
      <div class="caslide">
        <img src="<?php echo C('IMG_URL');?>/anli_name1.jpg" alt="">
      ...
      <div class="caslide">
        <img src="<?php echo C('IMG_URL');?>/anli_name2.jpg" alt="">
        <div class="caslide_left"></div>
      </div>
      <div class="caslide">
        <img src="<?php echo C('IMG_URL');?>/anli_name3.jpg" alt="">
      ...
      <div class="caslide">
        <img src="<?php echo C('IMG_URL');?>/anli_name4.jpg" alt="">
        <div class="caslide_right"></div>
      </div>
      <div class="caslide">
     <!--    <a href="Index/case_info"> <img src="<?php echo C('SITE_URL');?>/Public/Uploads/comm/anli_case4.jpg" alt=""></a> -->
        <a href="Index/case_info"> <img src="<?php echo C('SITE_URL');?>/Public/Uploads/comm/anli_case5.jpg" alt=""></a>
      </div>
    </div>
