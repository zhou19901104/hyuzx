...
<script type="text/javascript" src="/Public/index/js/jquery.mousewheel.min.js"></script>
<script type="text/javascript" src="/Public/index/js/jquery.carousel-1.1.js"></script>
</head>
<body>
<!-- 在线联系 -->
<!-- 浮动 -->
...
<div class="new-cont-wrap map-width">
	<ul class="pro-text">
		...
		<li class="p-r">
			<p class="tit-text"><span class="s-1">推荐专家<strong>Experts recommend</strong></span><span class="s-2"><a href="<?php echo U('Index/Index/doctor_list');?>">MORE&nbsp;></a></span></p>
			<ul class="zj-list">
				<?php if(is_array($doctor_list)): $i = 0; $__LIST__ = $doctor_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d_list): $mod = ($i % 2 );++$i;?><li>
						<a href="<?php echo U('Index/Index/doctor_info',array('id'=>$d_list['id']));?>">
			...
			<div class="pro-daily">
				<p class="tit-text"><span class="s-1">蜕变日记<strong>Metamorphosis diary</strong></span><span class="s-2"><a href="<?php echo U('Index/Index/case_info');?>">MORE&nbsp;></a></span></p>
				<div class="bd">
					<a href="<?php echo U('Index/Index/case_info',array('id'=>$case_info['id']));?>">
...
<div class='con-list-wrap'>
	...
	<ul class="text-list">
		<?php if(is_array($related_list)): $i = 0; $__LIST__ = $related_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r_list): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Index/Index/new_info',array('id'=>$r_list['id']));?>"><?php echo ($r_list["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
	</ul>
</div>
</div>
	<p class="huawen"></p>
